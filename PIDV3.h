...
// working: .5,.5 imu and then ps at .4, no I, .6d, 
    float pid_p_gain_roll = .3; //1.3              //Gain setting for the roll P-controller
    float pid_i_gain_roll = 0.001; //.04              //Gain setting for the roll I-controller
    float pid_d_gain_roll = 0.6; //5.0             //Gain setting for the roll D-controller
    int pid_max_roll = 400;                    //Maximum output of the PID-controller (+/-)
    
    float pid_p_gain_pitch = .3;  //Gain setting for the pitch P-controller.
    float pid_i_gain_pitch = 0.001; //.04 //Gain setting for the pitch I-controller.
    float pid_d_gain_pitch = .6;  //3Gain setting for the pitch D-controller.
    int pid_max_pitch = pid_max_roll;          //Maximum output of the PID-controller (+/-)
    
    float pid_p_gain_yaw = 1.5;  //2              //Gain setting for the pitch P-controller. //4.0
